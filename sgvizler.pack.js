...
(function (window, undefined) { // trick: safekeep 'undefined', and minify.
    ...
    var document = window.document, // trick: minify.
        ...
        BorderCloud = {}, // local scope bordercloud variable.
...
//goo            moduleGooMap = registry.GMAP,
    ...
    S.visualization = (function () {
        ...
        var util = S.util,
            ...
            charts = S.charts,
            bordercloud= BorderCloud.visualization,
                ...
                for (r = 0; r < noRows; r += 1) {
                    ...
                    for (c = 0; c < noColumns; c += 1) {
                        if ((opti[c].length>0) && (opti[c][0][1])) {
                            ...
                            cells.push(['td', null, [C.util.linkify2String(data.getValue(r, c), optcol, opti[c][0][1])]]);
                        }
                        else{ 
...
// when Im trying to call it in an HTML
            B.Table_mult = charts.add(modSC, "Table_mult",
                function (data, chartOpt) {
                    var c, noColumns = data.getNumberOfColumns(),
                        r, noRows = data.getNumberOfRows(),
                        opt = $.extend({ headings: true, 
                        ...
                        i = 0,
                        opti = [];
console.log("inside bordercloud.table_mult");
                    Cutil.loadBOOTSTRAP();
